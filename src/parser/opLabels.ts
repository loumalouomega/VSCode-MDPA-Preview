...
export const OP_LABELS: Record<OpName, string> = {
  ...
  volumeMesh: "Generate volume mesh (retetrahedralize)",
  optimizeVolume: "Optimize tetrahedra (flips & relocation)",
  ...
  sdfDistance: "Signed distance to a surface",
  transferField: "Transfer fields from another mesh",
