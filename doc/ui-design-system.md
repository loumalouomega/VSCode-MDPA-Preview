...
- **Status pill**: bottom-center, `--ds-widget-bg`, radius 4, `padding: 6px 12px`, 12 px; errors recolor to `--ds-error`. Inline feedback beats toasts whenever the webview owns the flow.
