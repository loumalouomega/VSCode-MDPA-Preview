...
**Acceptance:** representative mixed-kind meshes with colliding per-kind IDs, vector/tensor fields, Properties, constraints, and nested SubModelParts survive applicable read/edit/write round trips; unsupported transformations report what cannot be retained. Existing recipes, undo/redo, dirty-state handling, and hot-exit restore remain valid. **MCP:** shared adapter and diagnostics across all mesh tools; publish the capability inventory through a headless query.

### 2. Improve the UI and unify it with CAD-Preview — L
...
### 3. Run expensive meshio++ work in cancellable workers — L
...
### 4. Complete format, metadata, and transient integration — L
...
### 5. Diagnose and repair surface meshes — M
...
### 6. Surface simplification and display level of detail — M–L
...
### 7. Curvature analysis and geometry-aware sizing — M
...
### 8. Surface fitting and controlled deformation — M–L
...
### 9. Expand surface and volume meshing choices — L
...
### 10. Grids, voxelization, and sampled distance volumes — M–L
...
### 11. Compare meshes and simulation results — M–L
...
### 12. Export slices and isosurfaces; probe along paths — M
...
### 13. Export partitions, ghost layers, and connected components — M–L
...
### 14. Field management and conditioning — M
...
### 15. Selection-driven editing and Properties authoring — L
...
### 16. Saved view state and independent result comparison — M–L
...
**Acceptance:** missing fields/layers degrade predictably on reload, views never mark mesh geometry dirty, and nonmatching time grids are labelled. **MCP:** view presentation is UI-only; numeric comparison reuses item 11.

### 17. Reusable recipes and batch processing — M–L
...
### 18. Case preflight and isolated run workspaces — M–L
...
### 19. Export provenance and fidelity reports — M
...
### 20. Large-mesh rendering and end-to-end regression coverage — L
...
### 21. Curved high-order and native polyhedral fidelity — L
...
### 22. Optional Python companion for datasets and surrogate results — L
